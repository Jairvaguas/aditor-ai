...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col bg-[#0B1120] text-[#F0F0F0] font-sans selection:bg-[#FF6B6B]/30">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen px-6 max-w-7xl mx-auto pt-20 w-full relative">
        {/* Glow Effects */}
        ...
        <div className="max-w-2xl text-left animate-in fade-in slide-in-from-bottom-8 duration-1000 z-10">
        ...
        <div className="relative animate-in fade-in slide-in-from-right-8 duration-1000 delay-200 z-10 w-full max-w-lg mx-auto lg:mr-0 lg:ml-auto">
